    ...
    <div style={S.page}>
      <div style={S.leftPanel}>
        ...
        <div style={S.leftContent}>
          ...
          <div>
            <h2 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.15, margin: 0, marginBottom: 24 }}>Ton cash. Ton pilote. <span style={{ opacity: 0.8 }}>Zéro surprise.</span></h2>
            <p style={{ fontSize: 14, opacity: 0.9, lineHeight: 1.6 }}>Reconnecte-toi et retrouve ton tableau de bord trésorerie temps réel.</p>
          </div>
          <div style={{ fontSize: 11, opacity: 0.7 }}>Fait pour les TPE françaises</div>
        </div>
      </div>
      ...
      <div style={S.rightPanel}>
        <div style={S.formWrap}>
          <div style={S.mobileLogo}>
            <div style={S.logoBadge}>⚡</div>
            <div style={{ fontSize: 18, fontWeight: 800, color: "#0f172a" }}>CashOptimize</div>
          </div>

          <h1 style={S.title}>Bon retour 👋</h1>
          <p style={S.subtitle}>Connecte-toi à ton espace CashOptimize.</p>

          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <Field label="Email" type="email" value={email} onChange={setEmail} placeholder="toi@entreprise.com" />
            <Field label="Mot de passe" type="password" value={password} onChange={setPassword} placeholder="Ton mot de passe" />
  ...
  <Link href="/forgot-password" style={{ fontSize: 12, color: "#6366f1", fontWeight: 500, textDecoration: "none" }}>
    Mot de passe oublié ?
          ...
          <div style={S.divider}>
            ...
            <Link href="/signup" style={{ color: "#6366f1", fontWeight: 600, textDecoration: "none" }}>Créer un compte</Link>
          </div>
        </div>
      </div>
    </div>
...
const S: Record<string, React.CSSProperties> = {
  ...
  logoBadge: { width: 44, height: 44, borderRadius: 12, background: GRADIENT, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, color: "white", boxShadow: "0 4px 12px rgba(99,102,241,0.3)" },
  rightPanel: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 48 },
  formWrap: { width: "100%", maxWidth: 420 },
  mobileLogo: { display: "none", alignItems: "center", gap: 12, marginBottom: 32 },
